...
INSERT INTO annonce (idadresse, iddate, idheuredepart, idtypehebergement, idheurearrivee, idutilisateur, titreannonce, descriptionannonce, nombreetoilesleboncoin, montantacompte, pourcentageacompte, prixnuitee, minimumnuitee, nombreanimauxmax, nombrebebesmax, possibilitefumeur, capacite) VALUES
(51,30276,7,6,48,48,'Appartement cosy en centre-ville','Charmant appartement récemment rénové, situé au cœur du centre-ville, proche de toutes les commodités.',2,52,NULL,90,4,4,4,true, 4),
(52,30734,46,4,31,24,'Maison familiale avec grand jardin','Maison familiale spacieuse avec grand jardin arboré, idéale pour les familles à la recherche de tranquillité.',4,NULL,50,156,3,3,4,false, 8),
(53,30560,43,6,33,48,'Studio idéal pour étudiant','Studio fonctionnel et meublé, parfait pour un étudiant ou un jeune actif.',5,51,NULL,55,1,2,3,true, 2),
(54,29458,29,3,24,48,'Loft moderne en plein centre','Loft moderne avec belle hauteur sous plafond, dans un quartier dynamique et recherché.',4,137,NULL,98,3,5,3,false, 4),
(55,31551,34,9,15,47,'Appartement lumineux avec balcon','Appartement lumineux avec balcon orienté sud, vue dégagée sans vis-à-vis.',3,59,NULL,153,2,1,3,false, 4),
(56,31960,47,2,29,24,'Charmante maison proche des écoles','Jolie maison entièrement rénovée, à proximité des écoles et commerces.',2,NULL,76,47,1,1,5,true, 6),
(57,31956,25,6,16,29,'Studio rénové et meublé','Studio calme en résidence sécurisée, à deux minutes du métro.',3,73,NULL,141,3,2,1,false, 2),
(58,30986,46,6,25,2,'Appartement spacieux vue dégagée','Appartement spacieux avec grande terrasse privative, idéal pour les repas en extérieur.',3,NULL,48,168,3,5,4,false, 6),
(59,30104,11,4,32,49,'Maison de village rénovée','Maison de village au charme ancien, restaurée avec goût.',2,NULL,88,100,3,2,4,true, 6),
(60,30198,46,1,44,23,'Loft industriel très lumineux','Appartement en dernier étage avec ascenseur, très lumineux et bien isolé.',4,142,NULL,104,3,2,0,true, 4),
(61,30934,10,2,19,25,'Appartement proche des transports','Maison avec piscine chauffée et terrain clos, parfaite pour les familles.',1,NULL,15,59,4,1,2,true, 8),
(62,31077,40,8,3,38,'Maison avec piscine privée','Studio pratique avec kitchenette équipée, proche université et transports.',5,NULL,59,134,2,0,4,false, 2),
(63,30204,43,9,43,24,'Studio calme dans résidence','Appartement moderne dans résidence récente, avec parking sécurisé.',2,76,NULL,111,1,3,0,true, 4),
(64,30765,47,2,12,24,'Appartement terrasse plein sud','Maison avec garage et sous-sol complet, dans un quartier résidentiel.',1,113,NULL,54,3,3,2,true, 6),
(65,31543,3,8,29,24,'Jolie maison à la campagne','Studio refait à neuf, idéal pour un premier logement.',2,137,NULL,71,2,2,4,false, 2),
(66,31897,30,2,30,27,'Duplex moderne centre-ville','Appartement climatisé avec grande pièce de vie et cuisine ouverte.',2,58,NULL,59,3,2,2,false, 5),
(67,29490,46,4,1,24,'Studio proche de la gare','Maison en campagne avec belle vue dégagée sur la nature.',3,NULL,69,158,4,3,3,false, 6),
(68,31972,40,2,41,46,'Appartement rénové récemment','Appartement proche de la gare, parfait pour un quotidien sans voiture.',4,NULL,71,76,3,2,3,true, 4),
(69,31411,10,8,44,6,'Maison plain-pied quartier calme','Maison plain-pied très bien entretenue, aucune rénovation à prévoir.',2,147,NULL,139,2,4,0,false, 6),
(70,31775,3,6,28,48,'Appartement en dernier étage','Studio entièrement meublé, prêt à habiter immédiatement.',5,NULL,64,71,1,3,4,true, 2),
(71,31822,32,4,8,38,'Studio fonctionnel bien situé','Appartement avec cuisine équipée et rangements, très pratique au quotidien.',2,103,NULL,166,2,3,2,true, 4),
(72,31046,9,5,37,50,'Maison en bord de mer','Maison spacieuse avec quatre chambres, idéale pour grande famille.',5,NULL,80,183,1,0,2,false, 10),
(73,30107,23,6,34,29,'Appartement avec parking privé','Studio lumineux dans un quartier calme et recherché.',2,NULL,76,165,2,2,2,false, 2),
(74,29946,6,1,13,24,'Charmant studio hyper centre','Appartement en résidence sécurisée avec ascenseur et local vélo.',4,NULL,16,115,1,1,3,false, 4),
(75,30770,47,3,27,24,'Appartement vue sur parc','Maison ancienne rénovée avec goût, pierres et poutres apparentes.',4,NULL,85,89,4,1,5,false, 6),
(76,31987,45,3,4,45,'Maison avec grandes pièces','Studio bien agencé avec salle de bain moderne.',1,70,NULL,165,5,3,3,false, 2),
(77,29845,9,2,42,31,'Studio idéal court séjour','Appartement avec vue sur parc, proche commerces et transports.',2,89,NULL,65,5,1,5,false, 4),
(78,32051,36,6,44,48,'Appartement proche commerces','Maison avec terrasse couverte et grand terrain, parfaite pour les repas en été.',5,80,NULL,173,4,3,2,true, 8),
(79,29519,23,7,37,10,'Maison récente très lumineuse','Studio calme et isolé, parfait pour télétravailler sereinement.',3,NULL,47,163,4,0,3,false, 2),
(80,31342,12,7,10,41,'Studio meublé prêt à vivre','Appartement rénové récemment, aucun travaux à prévoir.',3,115,NULL,86,2,4,2,true, 4),
(81,31235,32,6,14,46,'Appartement avec cuisine équipée','Maison moderne avec prestations haut de gamme, dans un environnement paisible.',3,95,NULL,53,3,5,2,false, 7),
(82,29322,7,4,10,25,'Maison avec terrasse couverte','Studio idéal pour investissement locatif, forte demande dans le secteur.',2,138,NULL,116,3,1,0,false, 2),
(83,30611,23,6,40,46,'Studio en résidence sécurisée','Appartement situé dans une résidence récente avec ascenseur et parking.',5,NULL,55,100,3,0,5,false, 4),
(84,29888,40,2,22,38,'Appartement à deux pas du métro','Maison avec dépendance aménageable, idéal projet familial ou professionnel.',2,NULL,93,153,5,1,3,true, 8),
(85,29808,24,2,19,34,'Maison en lotissement calme','Studio proche des plages, parfait pour un pied-à-terre.',2,NULL,11,91,4,3,2,false, 2),
(86,31666,43,9,11,24,'Studio petite surface optimisée','Appartement très lumineux avec fenêtres double vitrage et isolation neuve.',1,63,NULL,52,2,2,4,true, 4),
(87,29792,12,8,28,38,'Appartement idéal colocation','Maison à la campagne, environnement calme sans voisins proches.',1,117,NULL,70,2,3,2,true, 6),
(88,31821,18,8,26,45,'Belle maison avec garage','Studio au cœur du centre historique, proche de toutes commodités.',3,124,NULL,130,4,0,2,false, 2),
(89,30509,45,7,5,41,'Studio au cœur du village','Appartement avec balcon et vue montagne, idéal pour les amoureux de nature.',4,120,NULL,92,3,1,3,false, 4),
(90,31478,6,8,9,41,'Appartement entièrement refait','Maison à rénover, beau potentiel pour projet personnel ou investissement.',1,NULL,52,69,4,3,0,false, 6),
(91,30987,32,7,35,5,'Maison avec vue montagne','Studio en parfait état, vendu entièrement équipé.',2,52,NULL,90,3,2,2,true, 2),
(92,30461,24,5,19,34,'Studio pas cher bien placé','Appartement rénové avec goût, mélange de moderne et ancien.',1,NULL,98,57,5,4,4,false, 4),
(93,31308,40,8,5,7,'Appartement standing centre historique','Maison proche océan, grande pièce de vie et jardin clos.',3,55,NULL,134,1,5,2,false, 6),
(94,29493,4,1,36,42,'Maison avec dépendances','Studio dans résidence étudiante sécurisée, emplacement idéal.',1,70,NULL,84,4,0,1,true, 2),
(95,31276,10,9,6,24,'Studio au calme absolu','Appartement spacieux avec trois chambres, idéal pour colocation.',2,NULL,53,54,3,1,5,false, 6),
(96,30999,11,2,42,41,'Appartement pratique pour étudiant','Maison récente avec chauffage économique et matériaux modernes.',4,NULL,45,108,2,4,2,true, 7),
(97,29526,17,6,38,48,'Maison pleine de charme','Studio lumineux au dernier étage, très faible vis-à-vis.',2,NULL,13,51,4,0,5,true, 2),
(98,30173,12,6,16,46,'Studio dans quartier vivant','Appartement avec cuisine ouverte et salon spacieux.',3,NULL,15,150,2,0,0,true, 4),
(99,31880,38,2,9,24,'Appartement proche université','Maison dans quartier résidentiel calme, proche écoles et parc.',2,66,NULL,69,1,5,4,true, 6),
(100,31300,47,8,3,6,'Maison spacieuse et lumineuse','Studio entièrement refait, prêt à louer immédiatement.',3,NULL,73,155,3,0,2,false, 2),
(101,30919,22,2,43,33,'Studio récent à louer','Appartement avec deux balcons, idéal pour profiter du soleil toute la journée.',3,NULL,53,100,4,5,3,false, 4),
(102,30771,21,8,32,41,'Appartement avec grande terrasse','Maison en bordure de forêt, idéale pour amoureux de la nature.',3,50,NULL,173,5,1,5,false, 6),
(103,31038,1,7,25,37,'Maison à deux niveaux','Studio avec belle hauteur sous plafond, possibilité mezzanine.',3,NULL,42,97,4,1,2,true, 2),
(104,30976,41,6,13,20,'Studio dans résidence neuve','Appartement dans résidence de standing avec espaces verts.',1,100,NULL,166,5,0,4,false, 4),
(105,29800,45,3,41,21,'Appartement proche du tram','Maison spacieuse avec atelier, idéale pour les bricoleurs.',1,NULL,28,94,5,2,2,false, 6),
(106,29919,23,3,45,42,'Maison avec terrain arboré','Studio fonctionnel en plein centre-ville.',3,120,NULL,131,2,4,5,true, 2),
(107,31906,8,2,14,32,'Studio en location saisonnière','Appartement en excellent état, vendu avec place de parking.',2,67,NULL,166,1,3,5,true, 4),
(108,31766,46,6,46,24,'Appartement en parfait état','Maison ancienne rénovée, charme ancien préservé.',1,NULL,37,68,4,3,2,false, 6),
(109,29379,14,4,26,24,'Ancienne maison rénovée','Studio parfait pour étudiant, proche de toutes commodités.',4,124,NULL,82,3,1,3,true, 2),
(110,30826,30,7,23,26,'Studio parfait pour débuter','Appartement en dernier étage avec grande luminosité naturelle.',4,55,NULL,65,1,1,1,true, 4),
(111,31304,19,4,40,28,'Appartement situé en centre historique','Maison avec grande terrasse et vue imprenable.',3,NULL,88,98,2,4,3,true, 6),
(112,31777,21,2,41,27,'Maison calme à rénover','Studio dans quartier vivant, commerces à proximité immédiate.',2,115,NULL,143,3,5,1,false, 2),
(113,30165,18,4,11,24,'Studio prix attractif','Appartement lumineux avec double exposition et cuisine équipée.',4,147,NULL,171,5,3,0,false, 4),
(114,30666,22,8,24,20,'Appartement avec vue mer','Maison avec jardin paysagé, aucun vis-à-vis.',4,89,NULL,86,4,0,2,true, 6),
(115,31199,8,1,42,39,'Maison isolée en forêt','Studio calme idéal télétravail.',1,NULL,64,53,3,1,4,true, 2),
(116,31709,36,8,37,24,'Studio proche toutes commodités','Appartement rénové récemment, quartier recherché.',3,NULL,48,71,4,3,4,false, 4),
(117,31795,45,9,25,24,'Appartement idéal investissement','Maison plein pied avec garage et buanderie.',5,80,NULL,146,1,3,2,false, 6),
(118,29435,9,6,16,32,'Grande maison proche plages','Studio à deux pas du tramway.',2,80,NULL,174,2,4,4,false, 2),
(119,31989,13,8,2,24,'Studio lumineux orientation sud','Appartement avec belle pièce de vie ouverte.',2,NULL,39,182,2,2,1,true, 4),
(120,30904,38,4,39,1,'Appartement entièrement meublé','Maison à grand potentiel, idéal investisseurs.',3,64,NULL,104,2,2,1,false, 6),
(121,30307,46,6,40,1,'Maison à fort potentiel','Studio cosy décoré avec goût.',2,NULL,89,182,4,1,5,true, 2),
(122,31334,10,1,33,47,'Studio dans immeuble récent','Appartement dans résidence calme et sécurisée.',4,90,NULL,73,1,5,1,false, 4),
(123,30994,46,7,38,7,'Appartement face à la mer','Maison en bord de rivière, cadre exceptionnel.',4,NULL,91,178,4,0,5,false, 7),
(124,30775,24,4,1,1,'Maison familiale proche commerces','Studio spacieux rare sur le secteur.',4,NULL,7,116,3,2,0,true, 3),
(125,29644,7,5,33,38,'Studio bien agencé','Appartement très bien situé, parfait pour première acquisition.',2,78,NULL,56,4,2,2,false, 4),
(126,31980,35,6,37,45,'Appartement avec grand séjour','Maison familiale proche plages.',2,NULL,35,124,4,0,3,true, 6),
(127,29759,20,3,44,50,'Maison en zone résidentielle','Studio lumineux dans immeuble récent.',2,NULL,37,134,2,4,4,false, 2),
(128,29908,20,1,45,24,'Studio moderne rénové','Appartement moderne vendu meublé.',3,88,NULL,154,2,4,1,true, 4),
(129,30480,39,3,8,1,'Appartement calme et spacieux','Maison avec cheminée et grand séjour.',4,63,NULL,59,5,4,2,false, 6),
(130,31442,39,5,33,48,'Grande maison plein centre','Studio pratique avec nombreux rangements.',2,NULL,21,174,4,2,2,true, 2);
