    ...
    <div class="bg-[#f8f9fb] min-h-screen py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-6 mb-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Bonjour, {{ auth()->user()->prenomutilisateur }}</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition group cursor-pointer">
                    <div class="text-orange-600 mb-4">
