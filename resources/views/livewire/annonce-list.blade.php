        ...
        <div class="w-full {{ $hasSearch ? 'lg:w-2/3' : '' }}">
            ...
            @else
                @foreach ($annonces as $annonce)
                    <div wire:key="annonce-{{ $annonce->idannonce }}" class="flex flex-col md:flex-row mb-6 gap-4 bg-white md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none p-3 md:p-0">
