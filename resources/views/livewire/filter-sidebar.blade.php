        ...
        <div>
            <div class="flex items-center gap-2 mb-4">
                ...
                <button type="button" onclick="
                    ...
                    console.log('Chambres bubble click', {x, y, rect});
                    if (window.AbsoluteHelpSystem) {
                        window.AbsoluteHelpSystem.show(x - 5, y + 1, '<strong>Filtre Précis</strong><br>Attention, ce filtre sélectionne le nombre <strong>exact</strong> de chambres (pas un minimum).', { width: 280, position: 'fixed' });
                    } else {
                        console.error('AbsoluteHelpSystem not found');
                        alert('Aide non disponible pour le moment');
                    }
