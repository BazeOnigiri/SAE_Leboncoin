<div class="h-full flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-6 hide-scrollbar space-y-8">
        ...
        <div>
            ...
            <div class="flex items-center justify-between mt-6">
                <div class="flex items-center gap-4">
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">1</button>
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">2</button>
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">3</button>
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">4</button>
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">5</button>
                    <button class=" border border-gray-300 hover:border-slate-400 rounded-lg px-4 py-2">6+</button>
                </div>
            </div>
        </div>
        ...
        <div class="" x-data="{ open: @entangle('showTypes') }">
