    ...
    <div class="bg-[#f8f9fb] min-h-screen pb-12">
        <main id="mainContent" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                @can('annonces.verif.*')
                    <a href="{{ route('services-petites-annonces.index') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Verifier Comptes</h2><p class="text-gray-500 text-sm mt-1">Verifier les comptes des utilisateurs</p></div>
                    </a>
                @endcan
                ...
                @if($isSuperAdminOrNoRoles)
                    <a href="{{ route('user.annonces') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Annonces</h2><p class="text-gray-500 text-sm mt-1">Gérer mes annonces déposées</p></div>
                    </a>
                    ...
                    <a href="#" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Transactions</h2><p class="text-gray-500 text-sm mt-1">Suivre mes achats et mes ventes</p></div>
                    </a>

                    <a href="{{ route('user.mes-reservations') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                    ...
                    <a href="{{ route('user.spaces') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Profil</h2><p class="text-gray-500 text-sm mt-1">Modifier mon profil public</p></div>
                    </a>
    
                    <a href="{{ route('user.settings') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        <div class="w-10 h-10 flex-shrink-0 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Paramètres</h2><p class="text-gray-500 text-sm mt-1">Infos privées</p></div>
                    </a>
    
                    <a href="{{ route('user.security') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                        <div class="w-10 h-10 flex-shrink-0 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600">
                        ...
                        <div><h2 class="text-lg font-bold text-gray-900">Connexion et sécurité</h2><p class="text-gray-500 text-sm mt-1">Sécurité du compte</p></div>
                    </a>
