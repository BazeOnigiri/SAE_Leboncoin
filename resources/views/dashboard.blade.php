        ...
        <main id="mainContent" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col md:flex-row gap-6 mb-8">
                ...
                <div class="md:w-96 bg-white border border-gray-200 rounded-xl shadow-sm p-6 pl-12 relative overflow-hidden flex flex-col justify-center">
                    ...
                    <div class="mt-2 z-10"><span class="text-3xl font-bold text-gray-900">0,00 €</span></div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('user.mesReservations') }}" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
