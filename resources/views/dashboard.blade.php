                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    @can('service.catalogue')
                        <a href="{{ route('services.catalogue.index') }}"
                            ...
                            <div>
                                <h2 class="text-lg font-bold text-gray-900">Catalogue</h2>
                                <p class="text-gray-500 text-sm mt-1">Ajouter des équipements et types d'hébergement</p>
                            </div>
                        </a>
                    @endcan

                    @can('service.annonce-editor')
                        <a href="{{ route('services.annonce-editor.index') }}"
                            class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                            <div class="w-10 h-10 flex-shrink-0 bg-indigo-50 rounded-lg flex items-center justify-center text-indigo-600">
                                {{-- Nouvelle icône : Crayon (Pencil) --}}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                </svg>
                            </div>
                            <div>
                                <h2 class="text-lg font-bold text-gray-900">Éditer les annonces</h2>
                                <p class="text-gray-500 text-sm mt-1">Gérer les équipements et types d'hébergement sur les annonces</p>
                            </div>
                        </a>
                    @endcan
                    ...
                    @if ($isSuperAdminOrNoRoles)
                        ...
                        <a href="{{ route('user.incidents.index') }}"
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm mt-1">Suivre l'état de vos signalements en cours</p>
                            </div>
                        </a>
