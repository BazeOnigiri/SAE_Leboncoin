    ...
    <div class="bg-[#f8f9fb] min-h-screen pb-12">
        <main id="mainContent" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col md:flex-row gap-6 mb-8">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-6">
                                <div class="relative w-24 h-24 flex-shrink-0">
                                    <div class="w-full h-full rounded-full overflow-hidden bg-gray-100 border border-gray-200 flex items-center justify-center text-3xl font-bold text-gray-400 relative group">
                                        ...
                                        @endif
                                        <a href="{{ route('user.edit') }}" class="absolute bottom-0 right-0 bg-white p-1.5 rounded-lg shadow-md border border-gray-100 hover:bg-gray-50 text-gray-700">
                                            <svg viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4"><path d="M21.731 2.269a2.625 2.625 0 113.71 3.71l-9.399 9.399-1.127 1.127a2.25 2.25 0 01-1.59.659h-5.376a.75.75 0 01-.75-.75v-5.376a2.25 2.25 0 01.659-1.59l1.128-1.127 9.399-9.399zM8.679 13.72a.75.75 0 10-1.06-1.06L5.25 15.031v2.421l2.421.26 2.369-2.369z" /></svg>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="md:w-96 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden relative flex items-center">
                    <div class="absolute -left-20"><svg width="200" height="200" viewBox="0 0 385 418" fill="none"><circle cx="192.629" cy="225.167" r="136" fill="#ea580c" fill-opacity="0.1"></circle></svg></div>
                    <div class="p-6 pl-12 relative z-10">
                        <h2 class="text-lg font-bold text-gray-900">Porte-monnaie</h2>
                        <div class="mt-2"><span class="text-3xl font-bold text-gray-900">0,00 €</span></div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="#" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Retrouver vos réservations</p>
                    </div>
                </a>
