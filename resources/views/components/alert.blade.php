<div class="bottom-0 right-0 mb-6 mr-6 fixed">
    @if (session('success'))
...
@if ($errors->has('error'))
    <div class="p-4 bg-red-50 border-l-4 border-red-500 text-red-800 border rounded-md">
        {{ $errors->first('error') }}
...
@if (session('info'))
    <div class="p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-800 border rounded-md">
        {{ session('info') }}
